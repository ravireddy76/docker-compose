package com.sb.poc.kafka.config;
...
public class SwaggerConfig {
    ...
    public Docket apiDoc() {
        return new Docket(DocumentationType.SWAGGER_2)
                .groupName("Spring Kafka POC")
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.sb.poc.kafka.controller"))
                .build()
                .useDefaultResponseMessages(true)
                .tags(new Tag("Spring Boot Kafka POC", "Proving the theory about how kafka partitions and offsets works"))
    ...
    private ApiInfo apiInfo() {
        return new ApiInfoBuilder()
                .title("Spring Boot Kafka POC")
                .description("Proving the theory about how kafka partitions and offsets works")
                .contact(new Contact("Spring Boot Kafka POC", null, "ravireddy76@gmail.com"))
                .version("2.0")
                .build();
    }
