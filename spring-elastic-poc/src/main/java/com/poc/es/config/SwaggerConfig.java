...
public class SwaggerConfig {
    ...
    public Docket newsApi() {
        return new Docket(DocumentationType.SWAGGER_2)
                .groupName("Spring Elastic Search POC")
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.poc.es.controller"))
                .build()
                .useDefaultResponseMessages(true)
                .tags(new Tag("Spring elastic poc", "Spring elastic-search poc to demonstrate how to store data in elastic search"))
    ...
    private ApiInfo apiInfo() {
        return new ApiInfoBuilder()
                .title("Spring elastic-search poc")
                .description("elastic-search poc to demonstrate how to store data in elastic search.")
                .contact(new Contact("Spring elastic search poc", null, "ravipocworld20@gmail.com"))
                .version("2.0")
                .build();
    }
