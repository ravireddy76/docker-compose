...
public class SwaggerConfig {
    ...
    public Docket apiDoc() {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .tags(new Tag("Spring Kafka PO", "Proving the theory about how kafka partitions and offsets works"))
    ...
    private ApiInfo apiInfo() {
        return new ApiInfoBuilder()
                ...
                .contact(new Contact("Spring Kafka POC", null, "ravireddy76@gmail.com"))
                .version("2.0")
                .build();
    }
