...
public class SwaggerConfig {
    ...
    public Docket newsApi() {
        return new Docket(DocumentationType.SWAGGER_2)
                .groupName("Spring GridFS POC")
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.poc.gridfs.controller"))
                .build()
                .useDefaultResponseMessages(true)
                .tags(new Tag("Spring gridfs poc", "Spring gridfs poc to demonstrate how to leverage mongodb gridfs to store large size documents"))
    ...
    private ApiInfo apiInfo() {
        return new ApiInfoBuilder()
                .title("Spring gridfs poc to demonstrate gridfs technology")
                .description("Gridfs poc to demonstrate how to leverage mongodb gridfs to store large size documents.")
                .contact(new Contact("Spring gridfs poc", null, "ravipocworld20@gmail.com"))
                .version("2.0")
                .build();
    }
