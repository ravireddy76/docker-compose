...
public class JsonUtils {
     ...
     * @throws IOException
     */
    public static <T> List<T> deserializeObjectsCollection(Class<?> clazz, String inputJson) throws IOException {
        ObjectMapper mapper = new ObjectMapper();

        List<T> objectsCollection = mapper.readValue(inputJson,
