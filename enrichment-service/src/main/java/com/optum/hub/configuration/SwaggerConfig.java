...
public class SwaggerConfig {
    ...
    public Docket newsApi() {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.optum.hub.controller"))
                .build()
    ...
    private ApiInfo apiInfo() {
        return new ApiInfoBuilder()
                .title("Enrichment service a data processing micro service")
                .description("Enrichment service to demonstrate data processing.")
                .contact(new Contact("Enrichment service", null, "ravipocworld20@gmail.com"))
                .version("2.0")
                .build();
    }
